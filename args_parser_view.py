...
parser.add_argument("--register-user", nargs=3, metavar=("EMAIL", "USERNAME", "PASSWORD"), help="Register a traveller")
parser.add_argument("--register-admin", nargs=3, metavar=("EMAIL", "USERNAME", "PASSWORD"), help="Register an admin")
parser.add_argument("--add-ticket", nargs=5, metavar=("START", "END", "ORIGIN", "DEST", "COST"), help="Add a ticket directly")
